...
# load Tanimoto split dataset and do train/val split
df_train = pd.read_csv('train_split_new.txt')
df_test = pd.read_csv('test_split_new.txt')
...
with open('val.txt', 'w') as filehandle:
