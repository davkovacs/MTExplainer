...
dataset=/home/dpk25/rds/hpc-work/pistachio/
save_model=${dataset}checkpoints/

python /home/dpk25/MolecularTransformer2/train.py -data ${dataset}  \
	-save_model ${save_model}pist_model \
	-seed 42 -gpu_ranks 0 -save_checkpoint_steps 10000 -keep_checkpoint -1 \
	-train_steps 1000000 -param_init 0 -param_init_glorot -max_generator_batches 32 \
	-batch_size 4096 -valid_batch_size 16 -batch_type tokens -normalization tokens -max_grad_norm 0 \
	...
	-train_from /home/dpk25/rds/hpc-work/pistachio/checkpoints/pist_model_step_990000.pt \
