...
save_model=/home/dpk25/rds/hpc-work/MolecularTransformer2_models/checkpoints/${dataset}/small/
data_dir=/home/dpk25/MolecularTransformer2/data/data/${dataset}/

python /home/dpk25/MolecularTransformer2/train.py -data ${data_dir}  \
	-save_model ${save_model}small_MIT \
	...
	-layers 4 -rnn_size 16 -word_vec_size 16 -encoder_type transformer \
	...
	#-train_from ${save_model}${dataset}_model_step_390000.pt \
