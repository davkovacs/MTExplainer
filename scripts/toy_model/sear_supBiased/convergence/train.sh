...
save_model=/home/dpk25/rds/hpc-work/toy_model/sear_models_supBiased_conv/

python /home/dpk25/MolecularTransformer2/train.py -data ${dataset}  \
	-save_model ${save_model}toy_model \
	-seed 42 -gpu_ranks 0 -save_checkpoint_steps 76 -keep_checkpoint -1 \
	-train_steps 2500 -param_init 0 -param_init_glorot -max_generator_batches 32 \
