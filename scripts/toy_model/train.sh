...
dataset=/home/dpk25/MolecularTransformer2/experiments/toy_model/data_9k/
save_model=/home/dpk25/rds/hpc-work/toy_model/reduction_9k/
...
python /home/dpk25/MolecularTransformer2/train.py -data ${dataset}  \
	...
	-train_steps 125000 -param_init 0 -param_init_glorot -max_generator_batches 32 \
	...
	-warmup_steps 3000 -learning_rate 2 -label_smoothing 0.0 -report_every 1000 \
	...
	-train_from ${save_model}toy_model_step_75000.pt \
