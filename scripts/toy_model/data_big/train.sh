...
dataset=/home/dpk25/rds/hpc-work/toy_model/data_big/
save_model=/home/dpk25/rds/hpc-work/toy_model/reduction_big/
...
python /home/dpk25/MolecularTransformer2/train.py -data ${dataset}  \
	...
	-warmup_steps 5000 -learning_rate 2 -label_smoothing 0.0 -report_every 1000 \
