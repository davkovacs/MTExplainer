...
model_list=/home/dpk25/rds/hpc-work/toy_model/sear_models_supBiased_conv/
savedir=./supBiased/
for num in {1..5}
do
    model_list=/home/dpk25/rds/hpc-work/toy_model/sear_models_supBiased_conv$num/
    for i in {1..6}
    do
        k=$((2**($i-1)))
        j=$((152*$k))
        python ../../../translate.py -model ${model_list}toy_model_step_$j.pt \
            ...
            -output ${savedir}conv_sB_m${num}_$j.txt \
